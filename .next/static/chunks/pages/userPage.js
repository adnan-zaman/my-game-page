...
function Game(props) {
  console.log("i am ".concat(props.gameName, " and editing is ").concat(props.isEditing));
...
function UserPage(props) {
  ...
  //setting state
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(props.games),
      favoriteGames = _useState[0],
      setFavoriteGames = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(favoriteGames),
  ...
  var favoriteGamesList = favoriteGames.map(function (game) {
    return /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxDEV"])(_components_Game__WEBPACK_IMPORTED_MODULE_2__["default"], {
      gameId: game.id,
      gameName: game.name,
