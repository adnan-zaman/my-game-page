...
function Game(props) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(0),
      y = _useState2[0],
      setY = _useState2[1]; //   console.log(`i am ${props.gameName} and I am clicked: ${clicked}`);
  //   function moveFunc(e) {
  //     e.preventDefault();
...
_s(Game, "TwaF3r6alEf4ZCY3HqXuGuO61xI=");
...
function UserPage(props) {
  ...
  function drop(e) {
    ...
    var newFaveGames = Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(favoriteGames);

    var i = Number(e.target.dataset.index);
    var j = Number(e.dataTransfer.getData("text/plain")); //console.log(e.target);
