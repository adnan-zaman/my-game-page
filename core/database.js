...
//test fakes
  ...
  exports.getUserById = sinon.fake();
  exports.getUserByEmail = sinon.fake();
  exports.getUserByDisplayName = sinon.fake();
  exports.addUser = sinon.fake();
  exports.getUsersFavoriteGames = sinon.fake();

  /**
   * Tests may replace fakes with more specific fakes.
   * resetFakes can be called to return everything to plain
   * fakes that return nothing.
   */
  exports.resetFakes = function () {
    for (const prop in module.exports) {
      if (prop !== "resetFakes") module.exports[prop] = sinon.fake();
    }
  };
}
